...
<div id="dlg" class="easyui-dialog" style="width:570px;height:320px;padding:10px" closed="true" buttons="#dlg-buttons">
    ...
    <tr>
      <td>Lokasi</td>
      <td><input name="lokasi" type="text" class="easyui-validatebox" id="lokasi" style="width:250px" readonly="readonly"></td>
    </tr>
     <tr><td colspan="3">&nbsp;</td></tr>
    <tr>
    ...
    <tr>
      <td>Nilai Rencana</td>
      <td><input name="nilai_rencana" type="text" class="easyui-validatebox" id="nilai_rencana" style="width:50px"></td>
    </tr>
	 <tr><td colspan="3">&nbsp;</td></tr>
    <tr>
      <td>Nilai Realiasi</td>
      <td><input name="nilai_realisasi" type="text" class="easyui-validatebox" id="nilai_realisasi" style="width:50px"></td>
    </tr>
    </table>
