...
<html lang="en-us" class="no-js">
	...
	<!-- Styles -->
       ...
       <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/scripts/jeasyui/themes/main.css">
        <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/scripts/jeasyui/themes/default/easyui.css">
        <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/scripts/jeasyui/themes/icon.css">
        ...
        <script type="text/javascript" src="<?=base_url()?>assets/scripts/jeasyui/jquery.edatagrid.js"></script>

        <script type="text/javascript" src="<?=base_url()?>assets/scripts/jeasyui/global.format.js">disableSelection(document.body); 
        </script>
